    ...
    <section id="projects" className="w-full max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-items-center">
        {projects.map((proj, index) => (
          ...
          >
            <h3 className="text-xl font-semibold text-blue-400">{proj.title}</h3>
        ...
        {selected && (
          ...
          >
            ...
            >
              ...
              {/* Stack */}
              <h4 className="text-base font-semibold text-gray-300 mb-2">Tech Stack Used:</h4>
              ...
              {/* Long Summary */}
              <p className="text-gray-300 leading-relaxed">{selected.summaryLong}</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
